...
function init()
  ...
  -- Try to create the top button after a delay to ensure topmenu is loaded
  addEvent(setupTopMenuButton, 100)
...
function hideHistory()
  ...
  local categories = gameStoreWindow:getChildById("categories")
  if categories and categories:getChildCount() > 0 then
    categories:getChildByIndex(1):focus()
  end
end
