...
local npcTitles = {
["Ruby the protector"] = {title = "[Aoller Seller]", color = "#f5c367"},
...
["Sam the looter"] = {title = "[Equipment Shop]", color = "#946d3e"},
["Yasmin the blessed by gods"] = {title = "[Blessing Seller]", color = "#e5f280"},
...
["Riona the tools vendor"] = {title = "[Tools Shop]", color = "#66d1a3"},
["Frodo the food seller"] = {title = "[Food Seller]", color = "#e5f280"},
...
["Milton the shotter seller"] = {title = "[Paladin Refiller]", color = "#f5c367"},
["Jeweler"] = {title = "[Collars and ring seller]", color = "#f5c367"}, 
["Josue the magician runemaker"] = {title = "[Potions and runes]", color = "#f5c367"},
