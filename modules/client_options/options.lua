...
function setupTopMenuButton()
  optionsButton = modules.client_topmenu.addRightToggleButton('optionsButton', tr('Options'), '/images/topbuttons/new/options', toggle, nil, nil, true)
end
...
function setOption(key, value, force)
  ...
  if key == 'rightPanels' or key == 'leftPanels' or key == 'cacheMap' then
