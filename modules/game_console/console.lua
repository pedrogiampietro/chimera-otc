SpeakTypesSettings = {
  ...
  channelWhite = { speakType = MessageModes.ChannelManagement, color = '#F2EBEB' },
...
SayModes = {
  [1] = { speakTypeDesc = 'whisper', icon = '/images/ui/console/icons/sound_button_0' },
  [2] = { speakTypeDesc = 'say', icon = '/images/ui/console/icons/sound_button_1' },
  [3] = { speakTypeDesc = 'yell', icon = '/images/ui/console/icons/sound_button_2' }
}
