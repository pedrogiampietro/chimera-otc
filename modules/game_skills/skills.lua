...
function setupTopMenuButton()
  skillsButton = modules.client_topmenu.addRightGameToggleButton('skillsButton', tr('Skills'), '/images/topbuttons/new/skills', toggle, nil, nil, true)
end
...
function setSkillBase(id, value, baseValue)
  ...
  elseif value < baseValue then
    ...
    widget:setColor('#918374') -- default
    skill:removeTooltip()
  end
end
...
function refresh()
  ...
  if hasAdditionalSkills then
    ...
    skillsWindow:setContentMaximumHeight(475)
  end
end
...
function onSkillButtonClick(button)
  ...
  if percentBar then
    ...
    if percentBar:isVisible() then
      button:setHeight(button.buttonHeight)
    else
      button:setHeight(27 - 6)
    end
  end
end
...
function onStaminaChange(localPlayer, stamina)
  ...
  if stamina > 2400 and g_game.getClientVersion() >= 1038 and localPlayer:isPremium() then
	...
	elseif stamina > 2400 and g_game.getClientVersion() < 1038 then
		...
		setSkillPercent('stamina', percent, text, 'white')
