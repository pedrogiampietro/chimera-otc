...
void main()
{
    ...
    if(vertex.x < u_Center.x) {
        vertex.x = effectTextureSize.x / 8.0;
    }
    if(vertex.x > u_Center.x) {
        vertex.x = effectTextureSize.x - effectTextureSize.x / 8.0;
    }
    if(vertex.y < u_Center.y) {
        vertex.y = effectTextureSize.y / 8.0;
    }
    if(vertex.y > u_Center.y) {
        vertex.y = effectTextureSize.y - effectTextureSize.y / 8.0;
    }
